...
export function CreateSellerForm() {
  ...
  return (
    <form action={action} className="space-y-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <h3 className="text-lg font-semibold text-slate-900">Invite new seller</h3>
      <p className="text-sm text-slate-500">Creates a user account and seller profile starting at level 1.</p>
